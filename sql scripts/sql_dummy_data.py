...
# query dbs to see if data is there
df = pd.read_sql_query("SELECT * FROM production_medications", db)



######### INSERT TREATMENTS-PROCEDURES/CPT ###########

insertQuery = "INSERT INTO production_treatments_procedures (cpt_codes, treatments_procedures_desciption) VALUES (%s, %s)"
...
# query dbs to see if data is there
df = pd.read_sql_query("SELECT * FROM production_treatments_procedures", db)



######### INSERT SOD/LOINC ###########

insertQuery = "INSERT INTO production_social_determinants (social_determinants_description, loinc_codes) VALUES (%s, %s)"
...
# query dbs to see if data is there
df = pd.read_sql_query("SELECT * FROM production_social_determinants", db)
